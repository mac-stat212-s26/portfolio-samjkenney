...
ggplot(airquality, aes(x = is.na(Ozone), y = Month)) + 
    geom_boxplot()
ggplot(airquality, aes(x = Month, color = is.na(Ozone))) + 
    geom_density()
```
Month 6 has the largest proportion of missing data

```{r}
ggplot(airquality, aes(x = is.na(Ozone), y = Wind)) + 
    geom_boxplot()
ggplot(airquality, aes(x = Wind, color = is.na(Ozone))) + 
    geom_density()
```

Wind seems to have no relationship with missingness of ozone.

```{r}
ggplot(airquality, aes(x = is.na(Ozone), y = Temp)) + 
    geom_boxplot()
ggplot(airquality, aes(x = Temp, color = is.na(Ozone))) + 
    geom_density()
```
