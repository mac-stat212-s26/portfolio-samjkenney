...
ggplot(edible_plants_clean, aes(x = reorder(taxonomic_name, diff), color = sunlight)) +
  ...
  labs(x = "Edible Plant Species", y = "Preferred pH Level", title = "Edible Plant Species by Preferred Soil pH and Sunlight Level", caption = "via TidyTuesday, by Sam Kenney")+
  theme_classic() +
